...
The first two assumptions imply that days in leap years count as 1&#x202F;/&#x202F;366 of a year but those in non-leap years count as 1&#x202F;/&#x202F;365 of a year. This is one of many possible conventions for adjusting days so that annual periods are in some sense uniform. It is not without precedent: it has in the past been used by the UK CMI for mortality analysis and it coincides with the *Actual/Actual (ISDA)* day-count convention in derivatives markets.
