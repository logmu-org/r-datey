...
- [`is_empty_interval()`](https://logmu-org.github.io/r-datey/reference/interval_properties.md)
  [`is_proper_interval()`](https://logmu-org.github.io/r-datey/reference/interval_properties.md)
  :

  Properties of a `datey_interval`

- [`` `$`( ``*`<datey_interval>`*`)`](https://logmu-org.github.io/r-datey/reference/interval_start_end.md)
  :
